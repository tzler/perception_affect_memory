...
data['hypothesis_space'] = 1 * hypothesis_space
...
data$relative_distance = data$distance
data$distance = abs(data$distance)
data['key_press'] = as.factor(data$key_press)
data$association = revalue(data$key_press, c('32'='novel','80'='positive', '81'='negative'))
...
data$match = as.character(data$valence) == as.character(data$association)
...
hypothesis_space = select(data, valence, distance, match, subject)[data$hypothesis_space==1,]
